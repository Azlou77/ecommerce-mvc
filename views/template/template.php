            ...
            <div class="row">
                <div class="col-lg-4  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h6>About Us</h6>
                        <p>
                            Découvrez l'élégance intemporelle et le style audacieux des Peaky Blinders dans notre
                            boutique. Nos costumes sur mesure incarnent le charme et la sophistication des années 1920,
                            parfaits pour affirmer votre caractère.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4  col-md-6 col-sm-6">
